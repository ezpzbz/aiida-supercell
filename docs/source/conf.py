# -*- coding: utf-8 -*-
"""
# Sphinx configuration for aiida-supercell
#
...
release = aiida_supercell.__version__
...
html_use_opensearch = 'http://aiida-supercell.readthedocs.io'
...
htmlhelp_basename = 'aiida-supercell-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_supercell')
